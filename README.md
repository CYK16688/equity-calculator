...
本项目以 [GNU Affero 通用公共许可证第 3 版或更新版本（AGPL-3.0-or-later）](LICENSE) 发布：

- 个人、学习、研究、商业使用和再分发都可以，你可以自由使用、修改和分享本项目。
- 如果你修改了本项目，并通过计算机网络向他人提供服务，须按 AGPL 第 13 条向这些用户提供对应的源代码。
- 需要豁免 copyleft 义务时（例如闭源集成、专有托管服务、企业内部交付要求免责），可申请商业授权，入口见 <https://github.com/CYK16688/equity-calculator/discussions>。
- 第三方依赖仍受其各自许可证约束；当前应用运行时不依赖第三方 npm 包。

AGPL-3.0-or-later 是 OSI 认可的开源许可证；如需其他许可安排，请与版权所有者联系。
